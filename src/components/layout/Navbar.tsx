        ...
        <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:block ml-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-2 border border-neutral-300 rounded-md leading-5 bg-neutral-50 placeholder-neutral-400 focus:outline-none focus:ring-primary-500 focus:border-primary-500 sm:text-sm"
                />
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-4 flex items-center md:ml-6">
              <Link
                to="/notes/new"
                className="p-1 ml-2 rounded-full text-neutral-700 hover:text-primary-600 hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-primary-500"
              >
                <PlusCircle className="h-6 w-6" />
              </Link>
              <button className="p-1 ml-2 rounded-full text-neutral-700 hover:text-primary-600 hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-primary-500">
          ...
          <div className="flex md:hidden">
            <Link
              to="/notes/new"
              className="p-1 rounded-full text-neutral-700 hover:text-primary-600 hover:bg-neutral-100 focus:outline-none focus:ring-2 focus:ring-primary-500 mr-2"
            >
              <PlusCircle className="h-6 w-6" />
            </Link>
            <button
